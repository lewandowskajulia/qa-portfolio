...
test.describe("Checkout form validation", () => {
  test("should proceed to checkout overview when the form is filled with valid data", async ({
    page,
  }) => {
  ...
  test("should display an error message when last name is missing", async ({
    page,
  }) => {
    await page.locator('[data-test="checkout"]').click();
    await page.locator('[data-test="firstName"]').fill("Qwe");
  ...
  test("should display an error message when first name is missing", async ({
    page,
  }) => {
    await page.locator('[data-test="checkout"]').click();
    await page.locator('[data-test="lastName"]').fill("Qwe");
  ...
  test("should display an error message when postal code is missing", async ({
    page,
  }) => {
    await page.locator('[data-test="checkout"]').click();
    await page.locator('[data-test="firstName"]').fill("Qwe");
  ...
  test("should allow form submission after closing the error message and providing missing data", async ({
    page,
  }) => {
    await page.locator('[data-test="checkout"]').click();
    await page.locator('[data-test="firstName"]').fill("Qwe");
...
test.describe("Order summary and purchase process", () => {
  ...
  test("should display product details and total price in the order summary", async ({
    page,
  }) => {
  ...
  test("should include tax in the total order price", async ({ page }) => {
    ...
    const itemPrice = Number(
      (itemPriceText ?? "").replace("Item total: $", ""),
    );
